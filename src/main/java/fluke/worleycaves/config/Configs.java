...
public class Configs 
{
	...
	public static boolean refreshConfig()
	{
		...
		surfaceCutoffValue = config.get("cagegen", "surfaceCutoffValue", -0.081, "Controls size of caves at the surface. Smaller values = more caves break through the surface.", -1.0, 1.0).getDouble(); //Default: -0.081 (45% of noiseCutoffValue)
